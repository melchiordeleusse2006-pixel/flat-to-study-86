...
const translations = {
  ...
  it: {
    ...
    'createListing.streetAddress': 'Indirizzo stradale',
    'createListing.monthlyRent': 'Affitto Mensile (EUR)',
    'createListing.deposit': 'Deposito (EUR)',
    'createListing.floor': 'Piano',
    'createListing.size': 'Dimensione (mq)',
    'createListing.agencyFee': 'Commissione Agenzia',
    'createListing.availableFrom': 'Disponibile Dal',
    'createListing.creating': 'Creazione...',
    'createListing.createListing': 'Crea Annuncio',
    'createListing.missingInfo': 'Informazioni Mancanti',
    'createListing.pleaseProvideRequired': 'Fornisci tutte le informazioni richieste',
