...
// Priority countries (commonly used in Europe for students)
export const priorityCountries = [
  "FR", "IT", "RO", "TR", "ES", "DE", "GB", "NL", "BE", "CH", "AT", "PT", "GR", "PL"
];

export const getPriorityCountries = (): Country[] => {
  return countries.filter(country => priorityCountries.includes(country.code));
};
