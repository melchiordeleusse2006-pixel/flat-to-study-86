-- Improve title/description fallback in multilingual listings function
...
AS $$
  SELECT 
    l.id,
    COALESCE(NULLIF(public.get_listing_text(l.title_multilingual, p_language), ''), l.title, 'Untitled Property') as title,
    l.type,
    COALESCE(NULLIF(public.get_listing_text(l.description_multilingual, p_language), ''), l.description, '') as description,
    l.address_line,
